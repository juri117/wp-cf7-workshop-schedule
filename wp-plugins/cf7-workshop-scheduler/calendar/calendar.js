  ...
  class Calendar {
    ...
    constructor(elem, opts) {
      ...
      this._eventClicked = function (e) {
        ...
        var date = new Date(this.events[evtid].startDate);
        this.clearSelection();
        this.selectDate(date);
      }.bind(this);
    ...
    async drawCalendar() {
      ...
      this.elem.insertAdjacentHTML('beforeend', "<div class='cjs-weekRow cjs-calHeader'><div class='button cjs-lastLink'>&#8249; " + lastMo + "</div><div class='button cjs-nextLink'>" + nextMo + " &#8250;</div><div class='cjs-moTitle'>" + monthName + " " + year + "</div></div>");
      // Draw day labels
